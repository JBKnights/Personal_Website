...
export const news: NewsItem[] = [
  ...
  {
    label: "2025",
    html: "Completed my PhD at QUT, a joint program with CSIRO&rsquo;s Data61, supervised by Peyman Moghadam, Clinton Fookes and Sridha Sridharan.",
  },
  {
    label: "2025",
    html: 'Our paper <a href="https://arxiv.org/abs/2409.10247" target="_blank" rel="noopener noreferrer">SOLVR</a>, a submap-oriented LiDAR-visual re-localisation pipeline developed at the Smart Robotics Lab, TU Munich, was accepted to <strong>ICRA 2025</strong>.',
  },
  {
    label: "2024",
    html: "Worked as a Research Engineer at the Smart Robotics Lab, Technical University of Munich, developing computer vision pipelines for autonomous drones as part of the EU Horizon project DigiForest.",
  },
  {
    label: "2024",
